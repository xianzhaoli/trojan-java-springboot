...
public class TrafficSchedule {
    ...
    public void trafficInfoSTask() {
        final String post = HttpUtil.post(centerServerConfig.getHost() + "/api/updateUsed", JSON.toJSONString(Collections.EMPTY_LIST), 5000);
    ...
    public void uploadUserUsedFlow() {
        ...
        final String post = HttpUtil.post(centerServerConfig.getHost() + "/api/updateUsed", JSON.toJSONString(userTraffics), 30000);
